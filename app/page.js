        ...
        <section id="typography" className="mb-16">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <div className="flex flex-col gap-4">
              <h1 className="text-5xl font-bold">Heading 1 - Extra Large</h1>
              <h2 className="text-4xl font-bold">Heading 2 - Large</h2>
              <h3 className="text-3xl font-bold">Heading 3 - Medium</h3>
  ...
  <div className="bg-white rounded-lg shadow-md p-8 space-y-6">
    ...
    <div>
      ...
      <p className="text-gray-600">
        ...
        npm commands to confirm that Node.js and npm are properly installed.
      </p>
